...
/*=========================================================================
  ...
  Module:    $RCSfile: ResampleImageFilter5.cxx,v $
  Language:  C++
  Date:      $Date: 2009-04-05 23:52:49 $
...
int Resampler:: itkResampleImageTest( )
...
const     unsigned int    Dimension = 3;
  ...
  reader->SetFileName("F:\\CTImage\\training\\dataset00\\image00.mhd" );
...
// Software Guide : BeginCodeSnippet
  const double factorX = atof( "2" );
  const double factorY = atof( "2" );
  const double factorZ = atof( "2" );
// Software Guide : EndCodeSnippet
...
// Software Guide : EndLatex 
  ...
  writer->SetFileName( "F:\\CTImage\\training\\dataset00\\image00_short_down.mhd" );
